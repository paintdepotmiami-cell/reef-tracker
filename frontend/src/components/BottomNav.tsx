...
const tabs = [
  ...
  { href: '/tools', icon: 'handyman', label: 'Tools', match: ['/tools', '/library', '/dosing', '/cycle', '/sos', '/articles', '/bioload', '/trends', '/pest-id', '/videos', '/maintenance', '/power-outage', '/quarantine', '/bio-accelerator', '/volume-calc', '/sump-guide', '/alerts'] },
